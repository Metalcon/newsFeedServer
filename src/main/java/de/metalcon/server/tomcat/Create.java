...
public class Create extends GraphityHttpServlet {
     ...
     */
    public static void
        setDiskFileItemFactory(final DiskFileItemFactory factory) {
        FACTORY = factory;
    }
    ...
    protected void doPost(
        ...
        final TomcatClientResponder responder =
                new TomcatClientResponder(response);
        response.setHeader("Access-Control-Allow-Origin",
                config.getHeaderAccessControl());
                ...
                // create a user
                    case USER:
                        ...
                        final CreateUserRequest createUserRequest =
                                CreateUserRequest.checkRequest(formItemList,
                                        createRequest, createUserResponse);
                        createResponse = createUserResponse;

                        if (createUserRequest != null) {
                            // create user
                            final CreateUser createUserCommand =
                                    new CreateUser(this, createUserResponse,
                                            createUserRequest);
                            commandQueue.add(createUserCommand);
                    ...
                    case FOLLOW:
                        ...
                        if (createFollowRequest != null) {
                            // create follow edge
                            final CreateFollow createFollowCommand =
                                    new CreateFollow(this,
                                            createFollowResponse,
                                            createFollowRequest);
                            commandQueue.add(createFollowCommand);
                    ...
                    default:
                        ...
                        final CreateStatusUpdateRequest createStatusUpdateRequest =
                                CreateStatusUpdateRequest.checkRequest(
                                        formItemList, createRequest,
                        ...
                        if (createStatusUpdateRequest != null) {
                            try {
                                ...
                                final CreateStatusUpdate createStatusUpdateCommand =
                                        new CreateStatusUpdate(this,
                                                createStatusUpdateResponse,
                                                createStatusUpdateRequest);
                                commandQueue.add(createStatusUpdateCommand);
    ...
    private void writeFiles(
        ...
        for (String fileIdentifier : items.getFileIdentifiers()) {
            ...
            if (fileInfo.getContentType().equals(fileItem.getContentType())) {
                ...
                final File file = writeFile(fileItem);
    ...
    private File writeFile(final FormFile fileItem) throws Exception {
        final String directory = getFileDir(fileItem.getContentType());

        // TODO: ensure unique file names
        final File file =
                new File(directory + System.currentTimeMillis() + "-"
