...
public class CreateStatusUpdateRequest extends CreateRequest {
     ...
     *            status update template used
     */
    public CreateStatusUpdateRequest(
            final CreateRequestType type,
    ...
    public static CreateStatusUpdateRequest checkRequest(
        ...
        final Node user =
                checkUserIdentifier(formItemList, createStatusUpdateResponse);
        if (user != null) {
            final String statusUpdateId =
                    checkStatusUpdateIdentifier(formItemList,
                            createStatusUpdateResponse);
            if (statusUpdateId != null) {
                final StatusUpdateTemplate statusUpdateTemplate =
                        checkStatusUpdateType(formItemList,
                                createStatusUpdateResponse);
    ...
    private static String checkStatusUpdateIdentifier(
        ...
        if (statusUpdateId != null) {
            final Node statusUpdate =
                    NeoUtils.getStatusUpdateByIdentifier(statusUpdateId);
