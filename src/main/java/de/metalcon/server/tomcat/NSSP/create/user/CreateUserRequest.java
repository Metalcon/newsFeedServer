...
public class CreateUserRequest extends CreateRequest {
    ...
    public static CreateUserRequest checkRequest(
        ...
        final String userId =
                checkUserIdentifier(formItemList, createUserResponse);
        if (userId != null) {
            final String displayName =
                    checkDisplayName(formItemList, createUserResponse);
            if (displayName != null) {
                final String profilePicturePath =
                        checkProfilePicturePath(formItemList,
                                createUserResponse);
     ...
     */
    private static String checkUserIdentifier(
            final FormItemList formItemList,
            final CreateUserResponse createUserResponse) {
        final String userId =
                formItemList
     ...
     */
    private static String checkDisplayName(
            final FormItemList formItemList,
            final CreateUserResponse createUserResponse) {
        final String displayName =
                formItemList
